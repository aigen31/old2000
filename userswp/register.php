...
<div class="uwp-content-wrap <?php echo esc_attr($css_class); ?>">
	<div class="uwp-registration">
		...
		<div class="uwp-footer-link uwp-login-now"><?php _e('Уже есть аккаунт?', 'userswp'); ?> <a rel="nofollow" href="<?php echo uwp_get_login_page_url(); ?>"><?php echo uwp_get_option("login_link_title") ? uwp_get_option("login_link_title") : __('Login here', 'userswp'); ?></a>
		</div>
